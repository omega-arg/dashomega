...
const ROLE_CONFIG = {
  ...
  DISEÑADOR: { 
    ...
    bgGradient: "bg-gradient-to-r from-violet-500/10 to-purple-500/10"
  },
  GESTOR_CONTENIDO: { 
    label: "Gestor Contenido", 
    icon: FileText, 
    color: "bg-indigo-500/20 text-indigo-300 border-indigo-500/30",
    gradientFrom: "from-indigo-500",
    gradientTo: "to-blue-500",
    bgGradient: "bg-gradient-to-r from-indigo-500/10 to-blue-500/10"
  },
  FINANZAS: { 
    label: "Finanzas", 
    icon: BarChart3, 
...
export default function EmployeeManagement({ userRole }: EmployeeManagementProps) {
  ...
  const loadEmployees = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Error de conexión al cargar empleados",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleCreateEmployee = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: errorData.error || "Error al crear empleado",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: "Error de conexión al crear empleado",
        variant: "destructive",
      });
    } finally {
  ...
  const handleUpdateEmployee = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: errorData.error || "Error al actualizar empleado",
          variant: "destructive",
        });
      }
    } catch (error) {
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <DialogContent className="bg-gradient-to-br from-slate-900 to-purple-900 border-purple-500/30 max-w-2xl">
                      ...
                      <form onSubmit={handleCreateEmployee}>
                        <div className="space-y-4 max-h-96 overflow-y-auto">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <Input 
                                ...
                                className="bg-slate-800/50 border-purple-600/30 text-white" 
                                placeholder="email@omegastore.com"
                                required 
                              />
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label htmlFor="salary" className="text-white">Salario (opcional)</Label>
                              <Input 
                                id="salary" 
                                type="number"
                            ...
                            <div>
                              <Label htmlFor="weeklyTarget" className="text-white">Meta Semanal (horas)</Label>
                              <Input 
                                id="weeklyTarget" 
                                type="number"
                                value={formData.weeklyTarget}
                                onChange={(e) => setFormData(prev => ({ ...prev, weeklyTarget: e.target.value }))}
                                className="bg-slate-800/50 border-purple-600/30 text-white" 
                                placeholder="40"
                              />
                            </div>
                  ...
                  <Dialog open={isEditEmployeeOpen} onOpenChange={setIsEditEmployeeOpen}>
                    <DialogContent className="bg-gradient-to-br from-slate-900 to-purple-900 border-purple-500/30 max-w-2xl">
                      <DialogHeader>
                        <DialogTitle className="text-white text-xl">Editar Empleado</DialogTitle>
                      </DialogHeader>
                      <form onSubmit={handleUpdateEmployee}>
                        <div className="space-y-4 max-h-96 overflow-y-auto">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label htmlFor="edit-name" className="text-purple-300">Nombre</Label>
                              <Input
                                id="edit-name"
                            ...
                            <div>
                              <Label htmlFor="edit-email" className="text-purple-300">Email</Label>
                              <Input
                                id="edit-email"
                                type="email"
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label htmlFor="edit-role" className="text-purple-300">Rol</Label>
                              <Select value={editFormData.role} onValueChange={(value) => setEditFormData({...editFormData, role: value})}>
                                ...
                                <SelectContent className="bg-slate-800 border-purple-500/30">
                                  {Object.entries(ROLE_LABELS).map(([role, label]) => (
                                    <SelectItem key={role} value={role} className="text-white hover:bg-purple-800">
                                      {label}
                                    </SelectItem>
                                  ))}
                                </SelectContent>
                            ...
                            <div>
                              <Label htmlFor="edit-country" className="text-purple-300">País</Label>
                              <Input
                                id="edit-country"
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label htmlFor="edit-salary" className="text-purple-300">Salario (opcional)</Label>
                              <Input
                                id="edit-salary"
                            ...
                            <div>
                              <Label htmlFor="edit-weeklyTarget" className="text-purple-300">Horas semanales objetivo</Label>
                              <Input
                        ...
                        <div className="flex gap-3 mt-6">
                          ...
                          >
                            {formLoading ? "Actualizando..." : "Actualizar Empleado"}
                          </Button>
                        </div>
                      </form>
                    </DialogContent>
